...
- Кандидат заходит в чат с ботом и нажимает команду `/start`
...
Выдаётся следующий список команд (меню ссылок)Ведение питомца. *После того, как новый усыновитель забрал собаку из приюта, он обязан
